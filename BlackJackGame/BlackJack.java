...
public class BlackJack {
    ...
    public static void main(String[] args) {
        ...
        int sumOfCard=Math.min(card1, 10)+ Math.min(card2, 10);
        System.out.println("Your total is "+ sumOfCard);
        ...
        while(true){
            ...
            System.out.println("Dealer's hidden total is "+dealerSum);
            System.out.println("Your total is "+sumOfCard);

            if(dealerSum >21){
                System.out.println("You win");
            }else if(dealerSum > sumOfCard){
                System.out.println("You lose");
            }
        }
    ...
    case  12:return
     ...
     case  13: return
            ...
            default:return "This wont be the outcome";        
